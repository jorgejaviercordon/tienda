...
//tipo precio seria
// function getUpdatetSQL($tipoUpdate) {

  //$sql = "UPDATE productos SET  $tipoUpdate  = '$this->descripcion', rebaja = $this->porcentajerebaja, estarebajas = $this->estaRebajado, precio = $this->precio = WHERE codigo= $this->codigo";
